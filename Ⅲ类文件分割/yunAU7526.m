...
while flag == 0
    ...
    if width < y1
        ...
        temp = my_imsplit(imcrop(plate_img5, [1,1,width+60,m]));
        [m, n] = size(temp);
        all = sum(sum(temp));
        ...
        plate_img5(:, [1:1]) = 0;
        plate_img6 = my_imsplit(imcrop(plate_img5, [width+62,1,n,m]));
        plate_img5 = my_imsplit(imcrop(plate_img5, [width+165,1,y-width-120,x]));
    end
end
