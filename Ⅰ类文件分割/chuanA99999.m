...
while flag == 0
    ...
    if width < y1
        ...
        temp = my_imsplit(imcrop(plate_img5, [1,1,width+8,m]));
        [m, n] = size(temp);
        all = sum(sum(temp));
        ...
        plate_img5(:, [1:1]) = 0;
        plate_img6 = my_imsplit(imcrop(plate_img5, [width+8,1,n,m]));
        plate_img5 = my_imsplit(imcrop(plate_img5, [4*width+3,1,y-4*width+3,x]));
    end
end
 ...
 imwrite(word1,'./chuanA99999/1.jpg'); % 创建七位车牌字符图像
 imwrite(word2,'./chuanA99999/2.jpg');
 imwrite(word3,'./chuanA99999/3.jpg');
 imwrite(word4,'./chuanA99999/4.jpg');
 imwrite(word5,'./chuanA99999/5.jpg');
 imwrite(word6,'./chuanA99999/6.jpg');
 imwrite(word7,'./chuanA99999/7.jpg');